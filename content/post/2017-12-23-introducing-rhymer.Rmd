...
---
<hr>
I'm proud announce that I have published my first R package, `rhymer`!  
...
* **Hadley Wickham** for the [`httr`](http://httr.r-lib.org) package that made API requests a breeze, [`testthtat`](http://testthat.r-lib.org) which made writing tests genuinly enjoyable, [`devtools`](https://github.com/hadley/devtools) which made first-time package deveopment a pain-free experience, and [`pkgdown`](http://pkgdown.r-lib.org) for turning all the package documentation into a beutiful website.
...
* [**Datamuse**](http://www.datamuse.com/api/) for provideing an awesome and free API with great documentation and examples.
* The internet for providing countless tips and tricks when it felt like I had reached an insurmountable problem.
* **Henry Willis**, **Tim Helbig**, and **Alex McManus** for teaching me a ton about package and software development and for doing some initial testing.
<hr>
