...
Browing the web, it seems like `DiagrammeR` is our best bet for a package that aids in the creation of diagrams and flowcharts. So, off we go!
...
Thanks to `DiagrammeR` creator Richard Iannone ([\@riannone](www.twitter.com/riannone)) and contributors by Kent Russell ([\@timelyportfolio](www.twitter.com/timelyportfolio)), JJ Allaire ([\@rstudio](www.twitter.com/rstudio)), and Michaël Benesty ([\@pommedeterre33](www.twitter.com/pommedeterre33)).
