...
* **Hadley Wickham** for the [`httr`](http://httr.r-lib.org) package that made API requests a breeze, [`testthat`](http://testthat.r-lib.org) which made writing tests genuinely enjoyable, [`devtools`](https://github.com/hadley/devtools) which made first-time package development a pain-free experience, and [`pkgdown`](http://pkgdown.r-lib.org) for turning all the package documentation into a beautiful website.
